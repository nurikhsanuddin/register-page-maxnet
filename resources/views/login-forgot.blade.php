...
<head>
    ...
    <title>Maxnet | Reset Password</title>
        ...
        <div class="flex flex-col items-center justify-center w-full px-6 mx-auto md:h-screen md:w-[500px]">
            ...
            <div class="w-full bg-white rounded-lg shadow-2xl md:mt-0 sm:max-w-md xl:p-0 ">
                <div class="p-6 md:space-y-6 sm:p-8 ">
                    ...
                    @endif
                    <form class="space-y-4 md:space-y-6" action="{{ route('login.sendemail') }}" method="POST"
                        onsubmit="disableSubmitButton()">
                        @csrf
                        <a href="javascript:history.back()" class="flex items-center text-md text-blue-500">
                        ...
                        <p class="text-sm text-slate-500">
                            Please enter your email to sending reset password request.
                        </p>
                        <div>
                            <label for="email"
